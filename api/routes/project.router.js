...
const authenticatedMiddleware = require("../middlewares/auth.middleware");
...
projectRouter.get("/city", projectController.test);

projectRouter.use("/:id", checkIdExistMiddleware(Project));
